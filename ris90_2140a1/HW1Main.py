...
import datetime
 ...
 # !!! YOU CANNOT CHANGE ANYTHING IN THIS CLASS !!! This is for INFSCI 2224 in 2022
...
def PreProcess(type):
    ...
    while True:
        ...
        count += 1
        if count % 10000 == 0:
            print(f'finish {count} docs') #changed this line as syntax was incorrect: print("finish " + count + " docs")
    wr.close()
    print(f'Total : {count} docs')   #changed this line as syntax was incorrect: print("Total: " + count + " docs")
    return
